<div class="col-md-8 col-md-offset-2">
    <div class="panel panel-succcess">
        ...
        <div class="panel-body">
            ...
            <p>
                Email sẽ được gởi đến hộp thư <i><?php echo $_GET['email']; ?></i> trong vòng 5 phút.
            ...
            <p class="text-center">
                <a href="authentication/fg_password">
                    <button class="save btn btn-primary">Nhập lại email kích hoạt</button>
                </a>
            </p>
            <div class="alert text-center w-hotline" role="alert">
                <h3>Liên hệ với chúng tôi nếu cần hỗ trợ </h3>
                <span class="glyphicon glyphicon-earphone"></span>Tổng đài: <strong
                        class="hotline">08.1214.4142</strong>
                <br>
                <span class="glyphicon glyphicon-phone"></span>Hotline: <strong class="hotline">08.1214.4142</strong>
