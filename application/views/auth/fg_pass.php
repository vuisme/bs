        ...
        <div class="col-md-10 col-md-offset-1">
            <form class="form-horizontal login-form" method="post" action="authentication/fg_password">
                ...
                <div class="form-group">
                    <input type="submit" name="forgot" value="Lấy Lại Mật khẩu" class="save btn btn-primary btn-sm"/>
                    <!-- <button type="submit" name="forgot" class="save btn btn-primary btn-sm btn-smf"><i class="fa fa-key"></i>Lấy lại mật khẩu</button>
