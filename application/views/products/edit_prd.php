                    ...
                    <div class="col-md-8">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-xs-6 padding-5" style="margin-top:10px">
                                <label>Tồn</label>
                                <div id="prd_sls_edit"
                                     class="hidden"><?php if (isset($data['_detail_product'])) echo cms_getInventory($data['_detail_product']['ID'], $store_id) ?></div>
                                <input type="text"
                                       id="prd_sls" <?php if (isset($data['_detail_product'])) echo $data['_detail_product']['prd_serial'] == 1 ? 'disabled' : ''; ?>
                                       value="<?php if (isset($data['_detail_product'])) echo cms_getInventory($data['_detail_product']['ID'], $store_id) ?>"
                                       placeholder="0"
                                       class="form-control text-right txtNumber"/>
                            </div>
                            <div class="col-md-6 col-xs-6 padding-5" style="margin-top:10px">
                                <label>Đơn vị tính</label>
                                <div class="col-md-12 padd-0" style="display: flex">
                            ...
                            <div class="col-md-6 col-xs-6 padding-5" style="margin-top:10px">
                                <label>Giá vốn</label>
                                <input type="text" id="prd_origin_price" <?php echo $can_view_price ? '' : 'disabled' ?>
                            ...
                            <div class="col-md-6 col-xs-6 padding-5" style="margin-top:10px">
                                ...
                                <input type="text" id="link" <?php echo $can_view_link ? '' : 'disabled' ?>
                    ...
                    <div class="col-md-12 padd-0 hidden" style="margin-top: 10px;">
                        <div class="row">
                            ...
                            <textarea id="prd_descriptions" cols="" class="form-control"
                                      rows="4"
                                      style="border-radius: 0;"><?php if (isset($data['_detail_product'])) echo $data['_detail_product']['prd_descriptions']; ?></textarea>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 padd-20">
                                <div class="zoomin jumbotron text-center" id="img_upload"
                                    ...
                                    <img src="public/templates/uploads/<?php if (isset($data['_detail_product'])) echo cms_show_image($data['_detail_product']['prd_image_url']); ?>"
                                         height="200">
