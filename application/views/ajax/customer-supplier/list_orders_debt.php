<div class="col-md-12 col-xs-12">
    <div class="col-md-4 col-xs-12 padd-0">
        <div class="left-action text-left clearfix ">
            <h3 id="order_info" style="margin-top: 10px;">Thu nợ</h3>
        </div>
    </div>
    <div class="col-md-8 col-xs-12 padd-0">
        <div class="row padd-0 receipt_debt_hide" id="receipt_order">
            ...
            <div class="col-md-2 col-xs-6 padd-0" style="margin-bottom: 5px;">
            ...
            <div class="col-md-2 col-xs-6 padd-0" style="margin-bottom: 5px;">
                <div class="col-md-12 col-xs-12" style="padding: 0px;display: inline-flex">
                    <button type="button" class="save btn btn-primary" onclick="save_total_receipt_order_in_customer()">
                        <i
                                class="fa fa-plus"></i> Thu tất cả
                    </button>
                    <button type="button" class="save btn" title="Hủy" onclick="cms_paging_order_by_customer_id(1);">
                        <i class="fa fa-times"
...
<table class="table table-bordered table-striped">
    ...
    <tr>
        ...
        <th class="text-center hidden-xs">Ngày bán</th>
    ...
    <?php if (isset($_list_orders) && count($_list_orders)) :
        foreach ((array)$_list_orders as $key => $item) :
            ...
            <tr class="order_debt" data-id="<?php echo $item['ID']; ?>">
                ...
                <td class="text-center hidden-xs"><span
                ...
                <td class="text-center hidden-xs"><?php echo cms_encode_currency_format($item['total_money']); ?>
                </td>
                <td class="text-center order_lack"
                ><?php echo cms_encode_currency_format($item['lack']); ?></td>
                <td class="text-center"><input id="receipt_money-<?php echo $item['ID']; ?>" style="min-width: 75px;"
                                               class="receipt_money form-control txtMoney" type="text"
                                               placeholder="Số tiền thu"">
                </td>
                <td class="text-center">
                    <button type="button" class="save btn btn-primary"
                            onclick="save_receipt_order_in_customer(<?php echo $item['ID']; ?>);" title="Đồng ý">
