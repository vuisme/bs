<div class="quick-info report row" style="margin-bottom: 15px;">
    <div class="col-md-12 col-xs-12 padd-0">
        ...
        <?php //echo cms_encode_currency_format((isset($total_orders['total_discount']) ? $total_orders['total_discount'] : 0)); ?><!--</h3>-->
...
<div class="table-responsive">
    <table class="table table-bordered table-striped">
        ...
        <?php if (isset($_list_customers) && count($_list_customers)) :
            foreach ((array)$_list_customers as $key => $item) :
                ?>
                <tr>
                                    ...
                                    <table class="table table-striped table-bordered table-hover dataTable">
                                        ...
                                        foreach ((array)$item['_list_orders'] as $order) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><?php echo cms_encode_currency_format($order['total_origin_price']); ?></td>
                                                <td class="text-center"><?php echo cms_encode_currency_format($order['total_money'] - $order['total_origin_price']); ?></td>
                                            </tr>
                                            <?php
                                        }
                                        ?>
