        ...
        <div class="form-horizontal">
            <div class="form-group">
                ...
                <div class="col-md-8 col-xs-6">
                    <span><?php echo isset($user) ? $user['display_name'] : ''; ?></span>
                </div>
            </div>
            <div class="form-group">
                <div class="col-md-4 col-xs-6">
                ...
                <div class="col-md-8 col-xs-6">
                    <strong><span><?php echo isset($user) ? $user['username'] : ''; ?></span></strong>
                </div>
            </div>
            <div class="form-group">
                <div class="col-md-4 col-xs-6">
                ...
                <div class="col-md-8 col-xs-6">
                    <button class="save btn btn-primary" id="btn-changepass"><i class="fa fa-retweet"></i> Đổi mật khẩu
                    </button>
                    <div class="form-hide form-change-password" style="display: none;">
                        <div>
                            ...
                            <div class="form-group">
                                ...
                                <button class="save btn btn-primary" onclick="cms_change_password();">Đổi mật
                                    khẩu
                                </button>
            ...
            <div class="form-group">
                ...
                <div class="col-md-8 col-xs-6">
                    <span><?php echo isset($user) ? $user['email'] : ''; ?></span>
                </div>
            </div>
            <div class="form-group">
                <div class="col-md-4 col-xs-6">
